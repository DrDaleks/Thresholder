...
public class Thresholder extends EzPlug
{
	...
	public void execute()
	{
		...
		case K_MEANS:
		{
			_thrs = KMeans.computeKMeansThresholds(inSeq, c, true, nbClasses.getValue().shortValue(),
					KMeans.DEFAULT_KMEANS_BINS);
			break;
		}
		default:
	...
	/**
	 * Threshold the given sequence channel with the specified thresholds, and returns the result as a labeled sequence.<br>
